 ...
 */
export function BubbleItem({ index, color, animDuration, useRandomness, blurAmount }) {
    ...
    return (React.createElement("div", { className: styles.bubbleItem, style: Object.assign({ animationDirection, backgroundColor: color, animationDuration: `${animDuration}s`, filter: `blur(${_blurAmount})`, WebkitFilter: `blur(${_blurAmount})` }, _randomnessStyles) }));
}
